...
<![endif]--> 
<meta name="google-site-verification" content="d4T0Lsfg0BUnLJF9c0CEQfexx8WYFCNhSxPSxDBGOK8" />
</head>
<body <?php body_class(); ?>>
<?php woo_top(); ?>
...
<div id="wrapper">
		...
		<div class="col-full">
			...
			<nav id="navigation" role="navigation">
				...
				if ( function_exists( 'has_nav_menu' ) && has_nav_menu( 'primary-menu' ) ) {
					wp_nav_menu( array( 'depth' => 6, 'sort_column' => 'menu_order', 'container' => 'ul', 'menu_id' => 'main-nav', 'menu_class' => 'nav fl', 'theme_location' => 'primary-menu', 'link_after' => ''
 ) );
				} else {
				?>
	...
	<?php woo_content_before(); ?>
		...
		<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('quote-line')) : else : ?>
		<?php endif; ?>
