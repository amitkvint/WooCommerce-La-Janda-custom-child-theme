...
<div id="wrapper">
	<div class="top-things clearfix">
	   <a href="http://lajanda.org/" class="top-logo">
		</a>
				<div class="social-links">
					<a href="http://www.facebook.com/lajandaspanishschool" class="icon-socialfacebook"></a>
					<a href="https://twitter.com/LaJandaVejer" class="icon-socialtwitter"></a>
					<a href="http://pinterest.com/lajanda/" class="icon-socialpinterest"></a>
					<a href="http://www.youtube.com/user/ihvejer" class="icon-socialplay"></a>
					<a href="http://lajanda.org/contact-la-janda-spanish-school/" class="icon-socialmail"></a>
					<div class="snail">
						<a href="#" class="icon-socialphone"></a>
						<a href="#" class="phone-number">+34 956447060</a>
					</div>
				</div>
					<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('tag-line')) : else : ?>
					<?php endif; ?>

	</div>    <?php woo_header_before(); ?>
